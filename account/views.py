...
def Home(request):
    ...
    context={'total_customer':total_customer,'total_order':total_order,'delivered':delivered,
             'pending':pending,'out_for_delivery':out_for_delivery,'customers':customers,'orders':orders}
...
def Cust(request,pk_test):
    ...
    orders = myFilter.qs
    context={'customers':customer,'orders':orders,'order_count':order_count,'myFilter':myFilter}
